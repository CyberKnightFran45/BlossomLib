...
public static void WriteErrorSilent(Exception error, ReadOnlySpan<char> msg = default)
{
bool isRedirected = _externalStream != null;
var oldStream = _externalStream;
