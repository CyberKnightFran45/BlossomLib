...
{
/// <summary> Get hash by using the .NET Providers. </summary>
...
public static NativeMemoryOwner<byte> ComputeBytes(ReadOnlySpan<byte> input,
                                                   ReadOnlySpan<char> providerName,
                                                   byte[] authCode)
{
...
public static NativeMemoryOwner<char> GetString(ReadOnlySpan<byte> input,
                                                ReadOnlySpan<char> providerName,
                                                byte[] authCode,
												StringCase strCase = default)
{
...
public static NativeMemoryOwner<char> GetString(Stream input, ReadOnlySpan<char> providerName, byte[] authCode,
                                                StringCase strCase = default)
{
